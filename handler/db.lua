...
function FW.DB.SetupTables()
    local createPlayersTableQuery = [[
        CREATE TABLE IF NOT EXISTS players (
            ...
            equipment_vest  LONGTEXT DEFAULT NULL,
            equipment_weapon LONGTEXT DEFAULT NULL,
            equipment_bag1  LONGTEXT DEFAULT NULL,
            equipment_bag2  LONGTEXT DEFAULT NULL,
...
function FW.DB.SavePlayer(row, cb)
    ...
    MySQL.query(
        ...
        ]],
        {
            ...
            row.position_z or 75,
            row.inventory or '[]',
            row.equipment_vest or nil,
            row.equipment_weapon or nil,
            row.equipment_bag1 or nil,
            row.equipment_bag2 or nil,
            row.ui_settings or '{}',
            row.daten or '{}',
            row.identifier
        },
